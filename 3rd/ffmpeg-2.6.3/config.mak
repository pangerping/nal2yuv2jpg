...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./../install --enable-gpl --disable-shared --enable-static --enable-libx264 --enable-nonfree --enable-pic --enable-decoder=h264 --enable-swscale --enable-swresample --disable-optimizations --disable-stripping --enable-debug
prefix=./../install
...
CC_IDENT=gcc 5.4.0 (Ubuntu 5.4.0-6ubuntu1~16.04.2) 20160609
ARCH=x86
INTRINSICS=none
CC=gcc
CXX=g++
...
CFLAGS=-I./../install/include   -std=c99 -fPIC -pthread  -D_GNU_SOURCE=1 -D_REENTRANT -I/usr/include/SDL  -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
...
DEPWINDRES=gcc
DOXYGEN=doxygen
LDFLAGS=-L./../install/lib  -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
...
EXTRALIBS=-lXv -lX11 -lXext -lxcb -lxcb-shm -lxcb -lxcb-xfixes -lxcb-render -lxcb-shape -lxcb -lxcb-shape -lxcb -lX11 -lsndio -lasound -lSDL -lx264 -lm -lz -pthread 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=
